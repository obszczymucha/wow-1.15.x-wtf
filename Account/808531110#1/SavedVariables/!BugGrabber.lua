...
{
["message"] = "bad argument #1 to '?' (Usage: local name, instanceType, isHeroic, isChallengeMode, displayHeroic, displayMythic, toggleDifficultyID, isLFR, minPlayers, maxPlayers = GetDifficultyInfo(difficultyID))",
["time"] = "2025/11/30 19:10:51",
["locals"] = "(*temporary) = \"bad argument #1 to '?' (Usage: local name, instanceType, isHeroic, isChallengeMode, displayHeroic, displayMythic, toggleDifficultyID, isLFR, minPlayers, maxPlayers = GetDifficultyInfo(difficultyID))\"\n",
["stack"] = "[C]: in function 'GetDifficultyInfo'\n[Interface/AddOns/Blizzard_ReadyCheck/Classic/ReadyCheck.lua]:33: in function 'ShowReadyCheck'\n[Interface/AddOns/Blizzard_ReadyCheck/Classic/ReadyCheck.lua]:56: in function <...ce/AddOns/Blizzard_ReadyCheck/Classic/ReadyCheck.lua:54>",
["session"] = 879,
["counter"] = 1,
},
},
